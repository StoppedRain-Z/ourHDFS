...
java -cp miniHDFS-0.0.1-SNAPSHOT.jar cn.zrtcx.miniHDFS.HDFSServer.namenode.Namenode ${namenode_ip} ${datanode_ip} ${namenode_src_path} ${datanode_src_path} ${rpc_port} ${socket_port}
